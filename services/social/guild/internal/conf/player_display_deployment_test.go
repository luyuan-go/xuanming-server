...
func TestGuildDeploymentConfigsCarryPlayerDisplayResolvers(t *testing.T) {
	for _, name := range []string{"guild-dev.yaml", "guild-dev-tidb.yaml", "guild-prod.yaml.example"} {
		t.Run(name, func(t *testing.T) {
			...
			if cfg.Guild.PlayerNameResolverAddr == "" || cfg.Guild.PlayerNoResolverAddr == "" {

...
class ChestGroupRow(_message.Message):
...
class ChestGroupTableData(_message.Message):
    __slots__ = ("rows",)
    ROWS_FIELD_NUMBER: _ClassVar[int]
    rows: _containers.RepeatedCompositeFieldContainer[ChestGroupRow]
    def __init__(self, rows: _Optional[_Iterable[_Union[ChestGroupRow, _Mapping]]] = ...) -> None: ...
